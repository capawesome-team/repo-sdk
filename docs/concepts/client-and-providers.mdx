...
enterprise instances. See [Authentication](/authentication) for the per-provider auth shapes.
...
provider from `repo-sdk/testing` — see [Testing](/testing).
:::
...
<Card title="Next: Repositories & namespaces" icon="folder-git" href="/concepts/repositories-and-namespaces">
