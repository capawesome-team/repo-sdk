...
[retry configuration](/concepts/client-and-providers#retry-configuration). For anything beyond that, use
...
<Card title="Next: Capabilities" icon="toggle-right" href="/concepts/capabilities">
