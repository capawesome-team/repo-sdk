...
first — see [Capabilities](/concepts/capabilities).
:::
...
string — only `project/repository` is. See [Repositories & namespaces](/concepts/repositories-and-namespaces).
:::

<Card title="Next: Working with commits" icon="git-commit" href="/guides/commits">
