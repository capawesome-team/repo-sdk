...
<CardGroup cols={2}>
  <Card title="Client & providers" icon="git-merge" href="/concepts/client-and-providers">
    How the client and provider factories fit together.
  </Card>
  <Card title="Repositories & namespaces" icon="folder-git" href="/concepts/repositories-and-namespaces">
  ...
  <Card title="Errors" icon="shield-alert" href="/concepts/errors">
