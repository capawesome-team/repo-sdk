...
For the endpoints behind these calls, and what the equivalent raw `fetch` requests look like, see
[using the Gitea API from TypeScript](/blog/gitea-api-typescript).
