...
Archives are only one place the five APIs pull apart. Authentication headers, pagination, and webhook verification diverge just as much — see [how the GitHub, GitLab, Bitbucket, Azure DevOps, and Gitea REST APIs differ](/blog/github-gitlab-bitbucket-azure-devops-api-differences) for the wider comparison.
